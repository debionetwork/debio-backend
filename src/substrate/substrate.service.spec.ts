...
class SubstrateServiceMock {
  ...
  bindEthAddressToSubstrateAddress(ethAddress: string, substrateAddress: string,) {
    return {};
  }
}
...
describe("Substrate Service", () => {
  ...
  describe("Service", () => {
    ...
    it("should call getSubstrateAddressByEthAddress method with expected params", () => {
        const getSubstrateAddressByEthAddressSpy = jest.spyOn(substrateService, 'getSubstrateAddressByEthAddress');
        const ethAddress = "";
        substrateService.getSubstrateAddressByEthAddress(ethAddress);
        expect(getSubstrateAddressByEthAddressSpy).toHaveBeenCalledWith(ethAddress);

    });
    
    it("should call getLastOrderByCustomer method with expected params", () => {
        const getLastOrderByCustomerSpy = jest.spyOn(substrateService, 'getLastOrderByCustomer');
    ...
    it("should call getOrderDetailByOrderID method with expected params", () => {
        const getOrderDetailByOrderIDSpy = jest.spyOn(substrateService, 'getOrderDetailByOrderID');
        const orderID = "";
    ...
    it("should call getBalanceAccount method with expected params", () => {
        const getBalanceAccountSpy = jest.spyOn(substrateService, 'getBalanceAccount');
        const accountId = "";
    ...
    it("should call setOrderRefunded method with expected params", () => {
        const setOrderRefundedSpy = jest.spyOn(substrateService, 'setOrderRefunded');
    ...
    it("should call sendDbioFromFaucet method with expected params", () => {
        const sendDbioFromFaucetSpy = jest.spyOn(substrateService, 'sendDbioFromFaucet');
        const accountId = "";
        const amount = "";
    ...
    it("should call bindEthAddressToSubstrateAddress method with expected params", () => {
        const bindEthAddressToSubstrateAddressSpy = jest.spyOn(substrateService, 'bindEthAddressToSubstrateAddress');
        const ethAddress = "";
        const substrateAddress = "";
        substrateService.bindEthAddressToSubstrateAddress(ethAddress, substrateAddress);
        expect(bindEthAddressToSubstrateAddressSpy).toHaveBeenCalledWith(ethAddress, substrateAddress);
