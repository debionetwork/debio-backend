...
import { queryServiceInvoiceById, setOrderPaid, SubstrateService } from "../../../../../common";
...
export class ServiceRequestProcessedHandler implements ICommandHandler<ServiceRequestProcessedCommand> {
  constructor(
