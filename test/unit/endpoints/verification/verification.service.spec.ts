...
import { convertToDbioUnitString, sendRewards, updateLabVerificationStatus } from '../../../../src/common/polkadot-provider';
...
describe('Verification Service Unit Tests', () => {
  ...
  it('should not send reward', async () => {
    ...
    expect(updateLabVerificationStatus).toHaveBeenCalledWith(API, PAIR, ACCOUNT_ID, VERIFICATION_STATUS);
