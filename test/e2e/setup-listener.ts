module.exports = async () => {
  ...
  const substrateFixture = require('./substrate-listener-fixture'); // eslint-disable-line
  const elasticsearchFixture = require('./elasticsearch-listener-fixture'); // eslint-disable-line
